...
let SeatToSeat = class SeatToSeat {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, price: { required: true, type: () => String }, seat: { required: true, type: () => require("./seat.entity").Seat }, secondseat: { required: true, type: () => require("./seat.entity").Seat }, created_at: { required: true, type: () => Date }, updated_at: { required: true, type: () => Date } };
    }
};
__decorate([
