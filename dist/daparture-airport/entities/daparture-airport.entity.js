...
const city_entity_1 = require("src/city/entities/city.entity");
const flight_entity_1 = require("src/flight/entities/flight.entity");
const typeorm_1 = require("typeorm");
let DapartureAirport = class DapartureAirport {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, flight: { required: true, type: () => Object }, city: { required: true, type: () => Object }, created_at: { required: true, type: () => Date }, updated_at: { required: true, type: () => Date } };
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", typeof (_a = typeof flight_entity_1.Flight !== "undefined" && flight_entity_1.Flight) === "function" ? _a : Object)
], DapartureAirport.prototype, "flight", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => city_entity_1.City, (city) => city.departure_airport),
    (0, typeorm_1.JoinColumn)(),
    __metadata("design:type", typeof (_b = typeof city_entity_1.City !== "undefined" && city_entity_1.City) === "function" ? _b : Object)
